...
const actualizarPosicionComida = () => {
    foodX = Math.floor(Math.random() * 20); // se establece el rango de 0 a 29
    foodY = Math.floor(Math.random() * 20); // se establece el rango de 0 a 29
};
...
const finJuego = () => {
    ...
    // Reiniciar el setInterval para iniciar el juego nuevamente
...
const iniciarJuego = () => {
    ...
    // Comprobando si la cabeza de la serpiente está en el borde del tablero
